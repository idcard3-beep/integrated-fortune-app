...
const timeMap={子: 0,丑: 2,寅: 4,卯: 6,辰: 8,巳: 10,午: 12,未: 14,申: 16,酉: 18,戌: 20,亥: 22,미상:-1,}
...
;}
const CHEONGAN=['甲','乙','丙','丁','戊','己','庚','辛','壬','癸'];const JIJI=['子','丑','寅','卯','辰','巳','午','未','申','酉','戌','亥',];const CHEONGAN_ELEMENT={甲: '木',乙: '木',丙: '火',丁: '火',戊: '土',己: '土',庚: '金',辛: '金',壬: '水',癸: '水',}
;const JIJI_ELEMENT={寅: '木',卯: '木',巳: '火',午: '火',辰: '土',戌: '土',丑: '土',未: '土',申: '金',酉: '金',亥: '水',子: '水',}
;const CHEONGAN_YINYANG={甲: '陽',乙: '陰',丙: '陽',丁: '陰',戊: '陽',己: '陰',庚: '陽',辛: '陰',壬: '陽',癸: '陰',}
;const JIJI_YINYANG={子: '陽',丑: '陰',寅: '陽',卯: '陰',辰: '陽',巳: '陰',午: '陽',未: '陰',申: '陽',酉: '陰',戌: '陽',亥: '陰',}
;const JIJANGGAN={子:[{gan: '壬',element: '水',strength: 7,type: '초기'}
,{gan: '癸',element: '水',strength: 23,type: '본기'}
,],丑:[{gan: '癸',element: '水',strength: 9,type: '초기'}
,{gan: '辛',element: '金',strength: 3,type: '중기'}
,{gan: '己',element: '土',strength: 18,type: '정기'}
,],寅:[{gan: '戊',element: '土',strength: 7,type: '초기'}
,{gan: '丙',element: '火',strength: 7,type: '중기'}
,{gan: '甲',element: '木',strength: 16,type: '정기'}
,],卯:[{gan: '甲',element: '木',strength: 10,type: '초기'}
,{gan: '乙',element: '木',strength: 20,type: '정기'}
,],辰:[{gan: '乙',element: '木',strength: 9,type: '초기'}
,{gan: '癸',element: '水',strength: 3,type: '중기'}
,{gan: '戊',element: '土',strength: 18,type: '정기'}
,],巳:[{gan: '戊',element: '土',strength: 7,type: '초기'}
,{gan: '庚',element: '金',strength: 7,type: '중기'}
,{gan: '丙',element: '火',strength: 16,type: '정기'}
,],午:[{gan: '丙',element: '火',strength: 10,type: '초기'}
,{gan: '己',element: '土',strength: 9,type: '중기'}
,{gan: '丁',element: '火',strength: 11,type: '정기'}
,],未:[{gan: '丁',element: '火',strength: 9,type: '초기'}
,{gan: '乙',element: '木',strength: 3,type: '중기'}
,{gan: '己',element: '土',strength: 18,type: '정기'}
,],申:[{gan: '戊',element: '土',strength: 7,type: '초기'}
,{gan: '壬',element: '水',strength: 7,type: '중기'}
,{gan: '庚',element: '金',strength: 16,type: '정기'}
,],酉:[{gan: '庚',element: '金',strength: 10,type: '초기'}
,{gan: '辛',element: '金',strength: 20,type: '정기'}
,],戌:[{gan: '辛',element: '金',strength: 9,type: '초기'}
,{gan: '丁',element: '火',strength: 3,type: '중기'}
,{gan: '戊',element: '土',strength: 18,type: '정기'}
,],亥:[{gan: '戊',element: '土',strength: 7,type: '초기'}
,{gan: '甲',element: '木',strength: 7,type: '중기'}
,{gan: '壬',element: '水',strength: 16,type: '정기'}
,],}
;const SIBIUNTEONG={甲:{亥: '長生',子: '沐浴',丑: '冠帶',寅: '建祿',卯: '帝旺',辰: '衰',巳: '病',午: '死',未: '墓',申: '絶',酉: '胎',戌: '養',}
...
,}
;const SIBIUNTEONG_DESC={長生: '새로운 생명이 시작되는 시기. 왕성한 생명력과 발전 가능성',沐浴: '정화와 세척의 시기. 불안정하지만 변화의 가능성',冠帶: '성장하여 관(冠)을 쓰는 시기. 사회적 지위 상승',建祿: '가장 왕성한 활동력. 자립과 독립의 시기',帝旺: '최고의 전성기. 권력과 영향력이 절정',衰: '쇠퇴의 시작. 활력 감소,신중함 필요',病: '질병과 어려움의 시기. 건강과 사업 주의',死: '죽음과 끝의 시기. 큰 변화나 위기',墓: '무덤에 들어가는 시기. 침체와 은둔',絶: '단절과 고립. 극복하면 새로운 시작',胎: '태아처럼 준비하는 시기. 내면 성장',養: '양육받는 시기. 도움을 받으며 성장',}
;const SIBIUNTEONG_SCORE={長生: 4,沐浴: 2,冠帶: 3,建祿: 5,帝旺: 5,衰: 2,病: 1,死: 0,墓: 1,絶: 0,胎: 2,養: 3,}
;const DAYMASTER_CHARACTERISTICS={甲: '큰 나무처럼 곧고 정직하며 리더십이 있습니다. 원칙을 중시하고 남을 돕는 것을 좋아하며 진취적입니다.',乙: '꽃이나 풀처럼 부드럽고 섬세하며 적응력이 뛰어납니다. 유연하고 친화력이 좋으며 예술적 감각이 있습니다.',丙: '태양처럼 밝고 열정적이며 사교적입니다. 남에게 온정을 베풀고 활발하며 낙천적입니다.',丁: '등불처럼 따뜻하고 세심하며 예의 바릅니다. 섬세하고 예술적 재능과 감수성이 풍부합니다.',戊: '큰 산처럼 중후하고 신뢰감이 있습니다. 포용력이 크고 인내심이 강하며 안정적이고 믿음직합니다.',己: '밭이나 정원처럼 섬세하고 배려심이 깊습니다. 실속을 챙기고 현실적이며 근면하고 성실합니다.',庚: '도끼나 칼처럼 강직하고 결단력이 있습니다. 정의감이 강하고 의리를 중시하며 용감하고 과단성이 있습니다.',辛: '보석처럼 세련되고 우아하며 미적 감각이 뛰어납니다. 품위가 있고 감성적이며 섬세합니다.',壬: '큰 바다처럼 포용력이 크고 지혜롭습니다. 융통성이 있고 통찰력이 뛰어나며 활동적이고 진취적입니다.',癸: '이슬이나 빗물처럼 섬세하고 지혜롭습니다. 직관력이 뛰어나고 사려 깊으며 조용하고 사색적입니다.',}
;const ELEMENT_DESC={木: '나무의 기운-생성과 성장을 상징. 인자하고 온화하며 창의적',火: '불의 기운-열정과 활동을 상징. 적극적이고 밝으며 사교적',土: '흙의 기운-포용과 신용을 상징. 성실하고 안정적이며 신뢰감',金: '쇠의 기운-결단과 강직함을 상징. 의지가 강하고 판단력 뛰어남',水: '물의 기운-지혜와 유연함을 상징. 총명하고 적응력이 뛰어남',}
;const ELEMENT_RELATIONS={생:{木: '火',火: '土',土: '金',金: '水',水: '木'}
,극:{木: '土',火: '金',土: '水',金: '木',水: '火'}
,}
;const CHEONGAN_HAP={甲己:{name: '중정지합',result: '土'}
,乙庚:{name: '인의지합',result: '金'}
,丙辛:{name: '위제지합',result: '水'}
,丁壬:{name: '음양지합',result: '木'}
,戊癸:{name: '무정지합',result: '火'}
,}
;const JIJI_YUKHAP={子丑: '土',寅亥: '木',卯戌: '火',辰酉: '金',巳申: '水',午未: '土',}
;const SAMHAP={寅午戌:{result: '火',name: '火局'}
,巳酉丑:{result: '金',name: '金局'}
,申子辰:{result: '水',name: '水局'}
,亥卯未:{result: '木',name: '木局'}
,}
;const JIJI_CHUNG={子午: true,丑未: true,寅申: true,卯酉: true,辰戌: true,巳亥: true,}
;const JIJI_HYUNG={寅巳申: '무은지형',丑戌未: '지세지형',子卯: '무례지형',}
;const JAHYUNG=['辰','午','酉','亥'];const JIJI_PA={子酉: true,丑辰: true,寅亥: true,卯午: true,巳申: true,未戌: true,}
;const JIJI_HAE={子未: true,丑午: true,寅巳: true,卯辰: true,申亥: true,酉戌: true,}
;const NAPEUM={甲子: '해중금',乙丑: '해중금',丙寅: '노중화',丁卯: '노중화',戊辰: '대림목',己巳: '대림목',庚午: '노방토',辛未: '노방토',壬申: '검봉금',癸酉: '검봉금',甲戌: '산두화',乙亥: '산두화',丙子: '간하수',丁丑: '간하수',戊寅: '성두토',己卯: '성두토',庚辰: '백랍금',辛巳: '백랍금',壬午: '양류목',癸未: '양류목',甲申: '정천수',乙酉: '정천수',丙戌: '옥상토',丁亥: '옥상토',戊子: '벽력화',己丑: '벽력화',庚寅: '송백목',辛卯: '송백목',壬辰: '장류수',癸巳: '장류수',甲午: '사중금',乙未: '사중금',丙辛: '산하화',丁酉: '산하화',戊戌: '평지목',己亥: '평지목',庚子: '벽상토',辛丑: '벽상토',壬寅: '금박금',癸卯: '금박금',甲辰: '불등화',乙巳: '불등화',丙午: '천하수',丁未: '천하수',戊申: '대역토',己酉: '대역토',庚戌: '차천금',申亥: '차천금',壬子: '상자목',癸丑: '상자목',甲寅: '대계수',乙卯: '대계수',丙辰: '사중토',丁巳: '사중토',戊午: '천상화',己未: '천상화',庚申: '석류목',辛酉: '석류목',壬戌: '대해수',癸亥: '대해수',}
;const NAPEUM_DESC={金: '단단하고 견고함. 신념이 확고하고 의지가 강함',木: '성장과 발전. 창의적이고 활동적이며 진취적',水: '지혜와 유연함. 적응력이 뛰어나고 통찰력이 있음',火: '열정과 명예. 밝고 적극적이며 사교성이 뛰어남',土: '신용과 포용. 믿음직하고 안정적이며 현실적',}
;const GONGMANG={甲子:['戌','亥'],甲戌:['申','酉'],甲申:['午','未'],甲午:['辰','巳'],甲辰:['寅','卯'],甲寅:['子','丑'],}
;const SINSAL={天乙貴人:{甲:['丑','未'],乙:['子','申'],丙:['亥','酉'],丁:['亥','酉'],戊:['丑','未'],己:['子','申'],庚:['丑','未'],辛:['子','申'],壬:['巳','卯'],癸:['巳','卯'],}
,天德貴人:{寅: '丁',卯: '申',辰: '壬',巳: '申',午: '壬',未: '丁',辛: '丁',酉: '申',戌: '壬',亥: '申',子: '壬',丑: '丁',}
,月德貴人:{寅: '病',卯: '甲',辰: '壬',巳: '庚',午: '病',未: '甲',辛: '庚',酉: '戊',戌: '壬',亥: '甲',子: '庚',丑: '戊',}
,學堂貴人:{甲: '死',乙: '午',丙: '申',丁: '酉',戊: '申',己: '酉',庚: '亥',辛: '子',壬: '寅',癸: '墓',}
,桃花殺:{寅午戌: '墓',巳酉丑: '午',申子辰: '酉',亥卯未: '子',}
,驛馬殺:{寅午戌: '申',巳酉丑: '亥',申子辰: '寅',亥卯未: '死',}
,劫殺:{寅午戌: '死',巳酉丑: '申',申子辰: '亥',亥卯未: '寅',}
,華蓋殺:{寅午戌: '戌',巳酉丑: '丑',申子辰: '辰',亥卯未: '未',}
,白虎大殺:{寅午戌: '酉',巳酉丑: '子',申子辰: '墓',亥卯未: '午',}
,三災:{寅午戌:['子','丑','寅'],巳酉丑:['卯','辰','巳'],申子辰:['午','未','申'],亥卯未:['酉','戌','亥'],}
,}
;const SINSAL_DESC={天乙貴人: '가장 강력한 길신. 귀인의 도움과 위기 구제',天德貴人: '하늘의 덕으로 복록이 많고 재난 면함',月德貴人: '달의 덕으로 온화하고 덕망이 높음',學堂貴人: '학문과 예술에 재능,명석한 두뇌',桃花殺: '이성운이 강하고 매력적이나 색난 주의',驛馬殺: '이동과 변화가 많음. 해외운과 활동성',劫殺: '재물 손실이나 도난 주의. 급격한 변화',華蓋殺: '예술과 종교적 재능. 고독하고 독특함',白虎大殺: '돌발사고와 혈광 주의. 충동적 행동 경계',三災: '3년간의 재난운. 모든 일에 신중함 필요',}
;const YUKCHIN_MALE={比劫: '형제',食傷: '자녀(아들)',財星: '처·재물',官星: '자녀(딸)',印星: '어머니',}
;const YUKCHIN_FEMALE={比劫: '자매',食傷: '자녀',財星: '아버지·재물',官星: '남편',印星: '어머니',}
;function getMonthJiji(month,day){
const monthMap=[{start:[2,4],jiji: '寅'}
,{start:[3,6],jiji: '墓'}
,{start:[4,5],jiji: '辰'}
,{start:[5,6],jiji: '死'}
,{start:[6,6],jiji: '午'}
...
if((hour===23 && minute >=30)||
 hour===0 ||(hour===1 && minute <=29)){return '子';}
else if((hour===1 && minute >=30)||
 hour===2 ||(hour===3 && minute <=29)){return '丑';}
else if((hour===3 && minute >=30)||
 hour===4 ||(hour===5 && minute <=29)){return '寅';}
else if((hour===5 && minute >=30)||
 hour===6 ||(hour===7 && minute <=29)){return '卯';}
else if((hour===7 && minute >=30)||
 hour===8 ||(hour===9 && minute <=29)){return '辰';}
else if((hour===9 && minute >=30)||
 hour===10 ||(hour===11 && minute <=29)){return '巳';}
else if((hour===11 && minute >=30)||
 hour===12 ||(hour===13 && minute <=29)){return '午';}
else if((hour===13 && minute >=30)||
 hour===14 ||(hour===15 && minute <=29)){return '未';}
else if((hour===15 && minute >=30)||
 hour===16 ||(hour===17 && minute <=29)){return '申';}
else if((hour===17 && minute >=30)||
 hour===18 ||(hour===19 && minute <=29)){return '酉';}
else if((hour===19 && minute >=30)||
 hour===20 ||(hour===21 && minute <=29)){return '戌';}
else if((hour===21 && minute >=30)||
 hour===22 ||(hour===23 && minute <=29)){return '亥';}
return '子';}
...
const ganjiKey=gan+ji;const napeumFull=NAPEUM[ganjiKey]|| '';if(napeumFull.includes('金'))return{full: napeumFull,element: '金'}
...
const ganIndex=CHEONGAN.indexOf(yearGan);const jiIndex=JIJI.indexOf(yearJi);const gapjaGroups=['甲子','甲戌','甲申','甲午','甲辰','甲寅'];let gapjaBase='';for(let i=0;i < 6;i++){const testGan='갑';const testJi=JIJI[(jiIndex-(ganIndex % 10)+i*2+12)% 12];const key=testGan+testJi;if(gapjaGroups.includes(key)){gapjaBase=key;break;}}
...
const dayElement=CHEONGAN_ELEMENT[dayGan];const elements=['木','火','土','金','水'];const dayIndex=elements.indexOf(dayElement);const targetIndex=elements.indexOf(targetElement);const diff=(targetIndex-dayIndex+5)% 5;const sipseongMap={0: '比劫',1: '食傷',2: '財星',3: '官星',4: '印星'}
;return sipseongMap[diff];}
function getSipseongDetailed(dayGan,targetGan){
const dayElement=CHEONGAN_ELEMENT[dayGan];const targetElement=CHEONGAN_ELEMENT[targetGan];const elements=['木','火','土','金','水'];const dayIndex=elements.indexOf(dayElement);const targetIndex=elements.indexOf(targetElement);const diff=(targetIndex-dayIndex+5)% 5;const dayYinYang=CHEONGAN_YINYANG[dayGan];const targetYinYang=CHEONGAN_YINYANG[targetGan];const sameYinYang=dayYinYang===targetYinYang;if(diff===0){return sameYinYang ? '比肩' : '劫財';}
else if(diff===1){return sameYinYang ? '食神' : '傷官';}
else if(diff===2){return sameYinYang ? '偏財' : '正財';}
else if(diff===3){return sameYinYang ? '偏官' : '正官';}
else if(diff===4){return sameYinYang ? '偏印' : '正印';}
return '未知';}
...
const birthElement=ELEMENT_RELATIONS['생'][item.element];if(birthElement===dayElement){score+=(item.strength/100)*5;}}
);}}
);Object.values(saju.cheongan).forEach((gan)=>{if(gan && CHEONGAN_ELEMENT[gan]===dayElement){score+=5;}}
);let level,desc;if(score >=45){level='太旺(태왕)';desc='일간이 극도로 강합니다. 설기(洩氣)가 필요하며,식상과 재성을 용신으로 사용합니다. 지나친 고집과 독선을 경계해야 합니다.';}
else if(score >=35){level='旺(왕)';desc='일간이 매우 강합니다. 식상,재성,관성으로 기운을 설기하는 것이 좋습니다. 자신감이 넘치나 타인을 배려해야 합니다.';}
else if(score >=25){level='中和(중화)';desc='일간이 적당히 강합니다. 가장 이상적인 상태로 균형이 잘 잡혀 있습니다. 상황에 따라 유연하게 대처할 수 있습니다.';}
else if(score >=15){level='弱(약)';desc='일간이 약합니다. 비겁과 인성으로 도움을 받아야 합니다. 과도한 식상,재성,관성은 부담이 됩니다. 자기관리와 건강에 주의가 필요합니다.';}
else{level='太弱(태약)';desc='일간이 극도로 약합니다. 반드시 비겁과 인성의 도움이 필요합니다. 무리한 일은 피하고 휴식과 재충전이 중요합니다. 건강관리에 특히 유의해야 합니다.';}
...
);const monthSipseong=getSipseong(dayGan,CHEONGAN_ELEMENT[monthGan]);let gyeokguk='';let gyeokgukDesc='';if(strength.level==='太弱(태약)' || strength.score < 10){const elementCount={}
;visibleElements.forEach((el)=>{elementCount[el]=(elementCount[el]|| 0)+1;}
 ...
 elementCount[a]> elementCount[b]? a : b);if(dominantElement !==dayElement){const dominantSipseong=getSipseong(dayGan,dominantElement);if(dominantSipseong==='財星'){gyeokguk='從財格(從財格)';gyeokgukDesc='재성을 따르는 격국입니다. 재물운이 강하고 사업가 기질이 있으나,재물에 집착하지 않도록 주의해야 합니다. 재성을 키우는 식상이 용신입니다.';}
else if(dominantSipseong==='官星'){gyeokguk='從殺格(從殺格)';gyeokgukDesc='관성(관살)을 따르는 격국입니다. 강한 상사나 환경에 순응하여 성공합니다. 조직생활에 적합하며,재성이 용신입니다.';}
else if(dominantSipseong==='食傷'){gyeokguk='從兒格(從兒格)';gyeokgukDesc='식상(자식)을 따르는 격국입니다. 예술,창작,교육 분야에 재능이 있습니다. 재성이 용신입니다.';}}}}
if(!gyeokguk){if(monthSipseong==='正官' || monthSipseong==='官星'){gyeokguk='正官格(정관격)';gyeokgukDesc='正官格은 명예와 지위를 중시하는 격국입니다. 공직이나 대기업에 적합하며,원칙과 규칙을 잘 지킵니다. 재성이 관성을 생하므로 용신이 됩니다.';}
else if(monthSipseong==='正財' || monthSipseong==='財星'){gyeokguk='正財格(정재격)';gyeokgukDesc='正財格은 재물 관리에 능하고 현실적입니다. 꾸준한 노력으로 재산을 축적합니다. 식상이 재성을 생하므로 용신이 됩니다.';}
else if(monthSipseong==='正印' || monthSipseong==='印星'){gyeokguk='正印格(정인격)';gyeokgukDesc='正印格은 학문과 교육에 소질이 있습니다. 지혜롭고 사려 깊으며,어머니의 덕이 있습니다. 관성이 인성을 생하므로 용신이 됩니다.';}
else if(monthSipseong==='食神' || monthSipseong==='食傷'){gyeokguk='食神格(식신격)';gyeokgukDesc='食神格은 온화하고 복록이 있습니다. 예술,요식업,서비스업에 적합합니다. 재성이 식신의 기운을 받아 용신이 됩니다.';}
else if(monthSipseong==='比劫'){gyeokguk='建祿格(건록격)';gyeokgukDesc='建祿格은 자립심이 강하고 독립적입니다. 창업이나 자영업에 적합하며,형제의 도움이 있습니다. 식상과 재성이 용신입니다.';}
else{gyeokguk='內外格(내외격)';gyeokgukDesc='특정 격국에 속하지 않는 복합적인 구조입니다. 다재다능하나 방향 설정이 중요합니다. 사주 전체의 균형을 보아 용신을 정해야 합니다.';}}
return{name: gyeokguk,desc: gyeokgukDesc}
;}
function analyzeYongsin(dayGan,saju,strength,gyeokguk){
const dayElement=CHEONGAN_ELEMENT[dayGan];const elements=['木','火','土','金','水'];let yongsin='';let huisin='';let gisin='';let yongsinDesc='';if(gyeokguk.name.includes('從')){if(gyeokguk.name.includes('財')){yongsin='食傷';huisin='財星';gisin='印星·比劫';yongsinDesc='식상으로 재성을 생하는 것이 핵심입니다. 창작,표현,기술 분야에서 재물을 얻습니다.';}
else if(gyeokguk.name.includes('殺')){yongsin='財星';huisin='食傷';gisin='印星·比劫';yongsinDesc='재성으로 관살을 생하는 것이 핵심입니다. 재물로 관계를 원활히 하고 지위를 얻습니다.';}
else if(gyeokguk.name.includes('我')){yongsin='財星';huisin='食傷';gisin='印星·比劫';yongsinDesc='식상의 기운을 재성으로 이어가는 것이 핵심입니다.';}}
else{if(strength.level==='太旺(태왕)' || strength.level==='旺(왕)'){yongsin='食傷';huisin='財星';gisin='印星·比劫';yongsinDesc='일간이 강하므로 식상으로 기운을 설기하고,재성으로 활용하는 것이 좋습니다. 창작,표현,사업 활동이 유리합니다.';}
else if(strength.level==='太弱(태약)' || strength.level==='弱(약)'){yongsin='印星';huisin='比劫';gisin='食傷·財星·官星';yongsinDesc='일간이 약하므로 인성으로 생부하고 비겁으로 도와야 합니다. 학문,기술,자격증 취득이 중요하며,협력자가 필요합니다.';}
else{const monthJi=saju.jiji.month;const monthElement=JIJI_ELEMENT[monthJi];const monthSipseong=getSipseong(dayGan,monthElement);if(monthSipseong==='財星'){yongsin='食傷';huisin='財星';gisin='比劫';yongsinDesc='재성이 투출하므로 식상으로 재성을 생하는 것이 좋습니다. 사업과 재물 관리에 유리합니다.';}
else if(monthSipseong==='官星'){yongsin='財星';huisin='印星';gisin='食傷';yongsinDesc='관성이 투출하므로 재성으로 관성을 생하고,인성으로 균형을 맞춥니다. 명예와 지위를 추구합니다.';}
else if(monthSipseong==='印星'){yongsin='官星';huisin='財星';gisin='食傷';yongsinDesc='인성이 투출하므로 관성으로 인성을 생하는 것이 좋습니다. 학문과 자격증이 도움이 됩니다.';}
else{yongsin='食傷';huisin='財星';gisin='印星';yongsinDesc='균형잡힌 사주이므로 식상으로 재능을 발휘하고 재성으로 결실을 맺는 것이 좋습니다.';}}}
const sipseongToElement=(sipseong)=>{const dayIndex=elements.indexOf(dayElement);const offsets={比劫: 0,食傷: 1,財星: 2,官星: 3,印星: 4}
;return elements[(dayIndex+offsets[sipseong])% 5];}
;const yongsinElement=yongsin.includes('·')? yongsin
 : sipseongToElement(yongsin);const huisinElement=huisin.includes('·')? huisin
 : sipseongToElement(huisin);const gisinElement=gisin.includes('·')? gisin : sipseongToElement(gisin);return{yongsin: yongsinElement,huisin: huisinElement,gisin: gisinElement,desc: yongsinDesc,}
;}
function analyzeYukchin(dayGan,saju,gender){
const yukchinMap=gender==='male' ? YUKCHIN_MALE : YUKCHIN_FEMALE;const analysis={}
;const sipseongCount={}
;['比劫','食傷','財星','官星','印星'].forEach((s)=>(sipseongCount[s]=0));const sipseongDetailedCount={}
;['比肩','劫財','食神','傷官','偏財','正財','偏官','正官','偏印','正印',].forEach((s)=>(sipseongDetailedCount[s]=0));Object.values(saju.cheongan).forEach((gan)=>{if(gan){const sipseong=getSipseongFromGan(dayGan,gan);sipseongCount[sipseong]++;const sipseongDetailed=getSipseongFromGanDetailed(dayGan,gan);sipseongDetailedCount[sipseongDetailed]++;}}
);Object.values(saju.jiji).forEach((ji)=>{if(ji && JIJANGGAN[ji]){const hongi=JIJANGGAN[ji].find((j)=> j.type==='본기' || j.type==='정기');if(hongi){const sipseong=getSipseongFromGan(dayGan,hongi.gan);sipseongCount[sipseong]++;const sipseongDetailed=getSipseongFromGanDetailed(dayGan,hongi.gan);sipseongDetailedCount[sipseongDetailed]++;}}}
);Object.entries(yukchinMap).forEach(([sipseong,relation])=>{const count=sipseongCount[sipseong];let desc='';if(relation.includes('형제')){if(count >=3)desc='형제자매가 많거나 친구,동료와의 인연이 깊습니다. 협력이 중요하나 경쟁도 있을 수 있습니다.';else if(count===0)desc='형제자매가 적거나 인연이 약합니다. 독자적으로 일하는 것을 선호합니다.';else
 desc='형제자매와 적당한 인연이 있습니다. 협력과 독립의 균형이 좋습니다.';}
else if(relation.includes('자녀')){if(count >=3)desc='자녀복이 많고 인연이 깊습니다. 표현력과 재능이 뛰어나며 창의적입니다.';else if(count===0)desc='자녀와의 인연이 늦거나 약할 수 있습니다. 자기표현을 더 해야 합니다.';else desc='자녀운이 적당합니다. 창작과 표현 활동이 도움이 됩니다.';}
else if(relation.includes('처')|| relation.includes('재물')){if(count >=3)desc='재물운이 강하고 배우자복이 있습니다. 다만 재물 관리에 주의가 필요합니다.';else if(count===0)desc='재물과 배우자 인연이 약합니다. 검소한 생활과 인연 관리가 필요합니다.';else
 desc='재물운과 배우자운이 적당합니다. 꾸준한 노력으로 재산을 모을 수 있습니다.';}
else if(relation.includes('남편')|| relation.includes('딸')){if(count >=3)desc='남편복(관직운)이 강하거나 딸 복이 많습니다. 명예와 지위를 얻을 수 있습니다.';else if(count===0)desc='남편(관직)과의 인연이 약합니다. 자유로운 직업이 맞을 수 있습니다.';else
 desc='남편운(관직운)이 적당합니다. 안정적인 조직생활이 가능합니다.';}
else if(relation.includes('어머니')){if(count >=3)desc='어머니의 덕이 크고 학문운이 좋습니다. 지혜롭고 신중합니다.';else if(count===0)desc='어머니와의 인연이 약하거나 일찍 독립합니다. 스스로 배우고 성장해야 합니다.';else
...
);JAHYUNG.forEach((ji)=>{const count=jijiList.filter((j)=> j===ji).length;if(count >=2){results.hyung.push({type: '자형',chars: `${ji}
${ji}
`}
);}}
...
-${jijiList[j]}
`,name: '육합',result: JIJI_YUKHAP[pair],}
);}}}
...
;const cheonul=SINSAL['天乙貴人'][yearGan]||[];jijiList.forEach((ji)=>{if(cheonul.includes(ji)){results.good.push({name: '天乙貴人',desc: SINSAL_DESC['天乙貴人'],ji,}
);}}
);const cheondeok=SINSAL['天德貴人'][saju.jiji.month];ganList.forEach((gan)=>{if(gan===cheondeok){results.good.push({name: '天德貴人',desc: SINSAL_DESC['天德貴人']}
);}}
);const woldeok=SINSAL['月德貴人'][saju.jiji.month];ganList.forEach((gan)=>{if(gan===woldeok){results.good.push({name: '月德貴人',desc: SINSAL_DESC['月德貴人']}
);}}
);const hakdang=SINSAL['學堂貴人'][dayGan];jijiList.forEach((ji)=>{if(ji===hakdang){results.good.push({name: '學堂貴人',desc: SINSAL_DESC['學堂貴人']}
);}}
);const getJijiGroup=()=>{for(let[pattern,_]of Object.entries(SINSAL['桃花殺'])){const chars=pattern.split('');if(chars.some((c)=> jijiList.includes(c))){return pattern;}}
return null;}
;const jijiGroup=getJijiGroup();if(jijiGroup){const dohwa=SINSAL['桃花殺'][jijiGroup];if(jijiList.includes(dohwa)){results.bad.push({name: '桃花殺',desc: SINSAL_DESC['桃花殺']}
);}}
...
let yang=0,yin=0;Object.values(saju.cheongan).forEach((gan)=>{if(gan && CHEONGAN_YINYANG[gan]){CHEONGAN_YINYANG[gan]==='陽' ? yang++: yin++;}}
...
;const detailedCounts={比肩: 0,劫財: 0,食神: 0,傷官: 0,偏財: 0,正財: 0,偏官: 0,正官: 0,偏印: 0,正印: 0,}
...
);jijiValues.forEach((ji)=>{if(ji && JIJANGGAN[ji]){const hongi=JIJANGGAN[ji].find((j)=> j.type==='본기' || j.type==='정기');if(hongi){const sipseong=getSipseongFromGan(dayGan,hongi.gan);counts[sipseong]++;const sipseongDetailed=getSipseongFromGanDetailed(dayGan,hongi.gan);detailedCounts[sipseongDetailed]++;}}}
...
const name=document.getElementById('name').value.trim();if(!name){alert('성명을 입력해주세요.');return;}
...
if(year < 1900 ||
 ...
 month > 12 ||
 day < 1 ||
 day > 31){alert('올바른 범위의 생년월일을 입력해주세요.');return;}
...
else if(selectedJi==='子-夜'){hourJi='子';hour=23;minute=30;timeType='night_zi';console.log('→ 夜子時 선택: hour=23,minute=30,timeType=night_zi');}
else if(selectedJi==='子-朝'){hourJi='子';hour=0;minute=30;timeType='morning_zi';console.log('→ 朝子時 선택: hour=0,minute=30,timeType=morning_zi');}
else{hourJi=selectedJi;hour=getHourFromJiji(selectedJi);minute=30;timeType='normal';console.log('→ 기타 지지 선택:',selectedJi,'hour=',hour);}
hasHourInfo=true;console.log('✅ hasHourInfo=true 설정 완료');}
else{console.log('❌ 지지가 선택되지 않음 또는 미상');}}
else if(timeInputType==='time'){const hourInput=document.getElementById('hour').value;const minuteInput=document.getElementById('minute').value;if(hourInput !==''){hour=parseInt(hourInput);minute=minuteInput ? parseInt(minuteInput): 0;if(hour < 0 || hour > 23 || minute < 0 || minute > 59){alert('시각은 0-23시,분은 0-59분 사이로 입력해주세요.');return;}
...
`;console.log('📅 생성된 birthDatetime:',birthDatetime);console.log('⏰ hour:',hour,'minute:',minute);console.log('🔧 timeType:',timeType);let calendarType='solar';if(calendar==='lunar'){calendarType=isYundal ? 'leap' : 'lunar';}
...
const genderText=saju.gender==='male' ? '남자(乾命)' : '여자(坤命)';const inputCalendarText=saju.calendar==='solar'
 ? '양력(陽曆)'
 : `음력(陰曆)${saju.isYundal ? '-윤달' : ''}
`;const inputBirthDateText=`${saju.birthDate.year}
년 ${saju.birthDate.month}
월 ${saju.birthDate.day}
일`;let lunarInfoText='';let solarInfoText='';if(saju.calendar==='solar'){if(saju.lunar){lunarInfoText=saju.lunar;}}
else{if(saju.solarConverted){solarInfoText=saju.solarConverted;}}
const hourText=saju.hasHourInfo
 ? saju.birthDate.hour !==null
 ? `${saju.birthDate.hour}
시 ${saju.birthDate.minute !==null ? saju.birthDate.minute+'분' : ''}
`
 : `${saju.jiji.hour}
시`
 : '시각 미상';const today=new Date();const currentYear=today.getFullYear();let age=currentYear-saju.birthDate.year+1;const resultSection=document.getElementById('result-section');const existingInfo=document.getElementById('user-info-display');if(existingInfo){existingInfo.remove();}
...
else if(gan===dayGan){if(pillar==='day'){ganSipseong='日干';}
else{ganSipseong='比肩';}
ganElement=CHEONGAN_ELEMENT[gan];}
let jiSipseong='';let jiElement='';if(ji && JIJANGGAN[ji]){const hongi=JIJANGGAN[ji].find((j)=> j.type==='본기' || j.type==='정기');if(hongi){const mainGan=hongi.gan;jiElement=JIJI_ELEMENT[ji];if(mainGan !==dayGan){jiSipseong=getSipseongFromGanDetailed(dayGan,mainGan);}
else{jiSipseong='比肩';}}}
...
-gongmang`);if(gongmangEl && ji){const isGongmang=getGongmang(yearGan,yearJi,ji);gongmangEl.textContent=isGongmang ? '⚠️ 공망' : '✓';gongmangEl.className=isGongmang
 ? 'gongmang-info'
 : 'gongmang-info empty';}}
...
(${elementCount[el]}
)`).join(',');const pillarNames={year: '년주',month: '월주',day: '일주',hour: '시주',}
...
`;}}}
 ...
 <span style="color:#666;">🔍 오행:</span> ${elementSummary}
<span style="color:#999;font-size:0.8em;">(클릭:神殺보기)</span>
 </div>`;additionalInfo+=`<div id="element-summary-details" style="display:none;padding-left:10px;border-left:3px solid #e0e0e0;">`;additionalInfo+=`<div style="margin-bottom:8px;font-size:0.9em;color:#888;"><span style="color:#666;">지장간:</span> ${jijangganSummary}
...
if(hap.samhap && hap.samhap.length > 0){hap.samhap.forEach((s)=>{if(s.pattern){const completeText=s.complete ? '완성' : '반합';hapDetails.push(`${s.type || '삼합'}
(${s.pattern}
)${completeText}
`);}}
);}
if(hapDetails.length > 0){hapSummary=hapDetails.join(',');additionalInfo+=`<div style="margin-bottom:8px;font-size:0.9em;"><span style="color:#666;">合(합):</span> <span style="color:#4caf50;">${hapSummary}
</span></div>`;}
else{additionalInfo+=`<div style="margin-bottom:8px;font-size:0.9em;color:#999;"><span style="color:#666;">合(합):</span> 없음</div>`;}}
if(hyungchungEnhanced){if(hyungchungEnhanced.chung.length===0 &&
 ...
 hyungchungEnhanced.wongjin.length===0){additionalInfo+=`<div style="margin-bottom:8px;font-size:0.9em;color:#999;"><span style="color:#666;">刑沖破害:</span> 없음(안정적)</div>`;}
else{const items=[];if(hyungchungEnhanced.chung.length > 0){const chungItems=hyungchungEnhanced.chung
 .map((c)=> c.name).join(',');items.push(`<span style="color:#d32f2f;">충(沖): ${chungItems}
</span>`);}
if(hyungchungEnhanced.hyung.length > 0){const hyungItems=hyungchungEnhanced.hyung
 .map((h)=> h.name).join(',');items.push(`<span style="color:#c62828;">형(刑): ${hyungItems}
</span>`);}
if(hyungchungEnhanced.pa.length > 0){const paItems=hyungchungEnhanced.pa.map((p)=> p.name).join(',');items.push(`<span style="color:#e64a19;">파(破): ${paItems}
</span>`);}
if(hyungchungEnhanced.hae.length > 0){const haeItems=hyungchungEnhanced.hae.map((h)=> h.name).join(',');items.push(`<span style="color:#f57c00;">해(害): ${haeItems}
</span>`);}
if(hyungchungEnhanced.wongjin.length > 0){const wonjinItems=hyungchungEnhanced.wongjin
 .map((w)=> w.pair).join(',');items.push(`<span style="color:#5d4037;">원진(怨嗔): ${wonjinItems}
</span>`);}
...
if(sinsalSummary){additionalInfo+=`<div style="margin-bottom:8px;font-size:0.9em;"><span style="color:#666;">神殺:</span> ${sinsalSummary}
</div>`;}}
const gongmangJi=[];jiList.forEach((ji)=>{if(ji){const isGongmang=getGongmang(yearGan,yearJi,ji);if(isGongmang){gongmangJi.push(ji);}}}
);if(gongmangJi.length > 0){additionalInfo+=`<div style="margin-bottom:8px;font-size:0.9em;"><span style="color:#666;">空亡:</span> <span style="color:#ff9800;">${gongmangJi.join(',')}
</span></div>`;}
else{additionalInfo+=`<div style="margin-bottom:8px;font-size:0.9em;color:#999;"><span style="color:#666;">空亡:</span> 없음</div>`;}
if(sinsal){const specialSinsal=[];sinsal.good.forEach((s)=>{if(['天乙貴人','學堂貴人'].includes(s.name)){specialSinsal.push(s.name);}}
);sinsal.bad.forEach((s)=>{if(['桃花殺','驛馬殺','三災','白虎大殺'].includes(s.name)){specialSinsal.push(s.name);}}
);if(specialSinsal.length > 0){additionalInfo+=`<div style="margin-bottom:8px;font-size:0.9em;"><span style="color:#666;">특수 神殺:</span> ${specialSinsal.join(',')}
</div>`;}}
...
" style="display:inline-block;padding:10px 20px;margin-right:10px;">${dayGan}
 ...
 <p><strong>▶ 기본 특성:</strong> ${DAYMASTER_CHARACTERISTICS[dayGan]}
</p>
 <p><strong>▶ 오행:</strong> ${el}
(${getElementClass(el)}
)-${ELEMENT_DESC[el]}
</p>
...
const html=`
 ...
 <p><strong>▶ 강약 점수:</strong> ${strength.score.toFixed(1)}
점/60점</p>
 <p><strong>▶ 해석:</strong> ${strength.score >=35
...
const html=`
 ...
 <p><strong>▶ 용신 활용법:</strong> ${yongsin.desc}
</p>
 <p><strong>▶ 실생활 적용:</strong></p>
 <ul style="margin-top:10px;line-height:1.8;">
 <li>용신(${yongsin.yongsin}
)에 해당하는 색상,방향,직업을 선택하세요</li>
 <li>희신(${yongsin.huisin}
)으로 용신을 보조하면 더욱 좋습니다</li>
 <li>기신(${yongsin.gisin}
)은 가능한 피하거나 최소화하세요</li>
 </ul>
 </div>
 `;document.getElementById('yongsin-analysis').innerHTML=html;}
function displayElements(elements){
const total=Object.values(elements).reduce((a,b)=> a+b,0);const names={木: '木(목)',火: '火(화)',土: '土(토)',金: '金(금)',水: '水(수)',}
...
%">${count}
 ...
 <strong>▶ 분포:</strong> ${names[max]}
이(가)${elements[max].toFixed(1)}
로 가장 많고,${names[min]}
이(가)${elements[min].toFixed(1)}
로 가장 적습니다.<br><br>
...
const total=yinyang.yang+yinyang.yin;const yangPct=((yinyang.yang/total)*100).toFixed(1);const chartHTML=`
 ...
 `;let summary=`<strong>▶ 비율:</strong> 陽 ${yangPct}
%/陰 ${(100-yangPct).toFixed(1)}
%<br><br>`;if(yinyang.yang > yinyang.yin+2){summary+='양의 기운이 강하여 적극적,활동적,외향적입니다. 리더십과 추진력이 뛰어나나 성급함을 경계해야 합니다.';}
else if(yinyang.yin > yinyang.yang+2){summary+='음의 기운이 강하여 차분하고 내향적이며 사려 깊습니다. 인내심과 포용력이 뛰어나나 소극적이지 않도록 주의해야 합니다.';}
else{summary+='음양의 균형이 잘 잡혀 있습니다. 상황에 따라 적극적이거나 신중할 수 있으며 조화로운 성격입니다.';}
...
const pillars=['hour','day','month','year'];const names=['시지','일지','월지','년지'];let html='';pillars.forEach((p,idx)=>{const ji=saju.jiji[p];if(ji && JIJANGGAN[ji]){const list=JIJANGGAN[ji];let ganHTML='';list.forEach((item)=>{ganHTML+=`
...
const meanings={比劫: '형제·친구·동료·경쟁',食傷: '표현·재능·자식·창의성',財星: '재물·배우자·실리·현실',官星: '직장·명예·권위·사회성',印星: '학문·어머니·지혜·학습',比肩: '형제·동료·평등·협력',劫財: '경쟁·분쟁·탈취·손실',食神: '재능·여유·복록·자식(딸)',傷官: '표현·예술·비판·자식(아들)',偏財: '유동재산·사업·활동·투자',正財: '고정재산·월급·안정·절약',偏官: '권력·승부·도전·군인·경찰',正官: '명예·직장·법·공무원·질서',偏印: '특수학문·예술·종교·의학',正印: '정규학문·어머니·명예·자격증',}
;if(sipseongDetailed){let itemHTML='';const groups={'比劫(비겁)':['比肩','劫財'],'食傷(식상)':['食神','傷官'],'財星(재성)':['偏財','正財'],'官星(관성)':['偏官','正官'],'印星(인성)':['偏印','正印'],}
...
개)</div>`;stars.forEach((star)=>{const count=sipseongDetailed[star]|| 0;if(count > 0){itemHTML+=`
 ...
 <strong>▶ 십성 분포:</strong> ${maxStar}
이(가)${sipseongDetailed[maxStar]}
개로 가장 많습니다.<br><br>
 <strong>▶ 해석:</strong> ${getDetailedSipseongInterpretation(maxStar,sipseongDetailed)}
`;document.getElementById('sipseong-analysis').innerHTML=itemHTML;document.getElementById('sipseong-summary').innerHTML=summary;}
 ...
 <strong>▶ 십성 분포:</strong> ${max}
이(가)${sipseong[max]}
개로 가장 많습니다.<br><br>
 <strong>▶ 해석:</strong> ${max==='比劫'
...
if(hap.cheonganHap.length===0 &&
 ...
 hap.samhap.length===0){document.getElementById('hap-analysis').innerHTML='<div class="no-hap">사주에 특별한 합이 없습니다</div>';return;}
...
(${h.name}
 ...
 합이 되면 새로운 오행(${hap.cheonganHap[0].result}
)으로 변화합니다.
 </div>
 </div>
 `;}
...
→ ${h.result}
 ...
 <div class="hap-desc">
 지지가 합하여 새로운 기운을 생성합니다. 변화와 발전의 계기가 될 수 있으며,결혼운이나 사업 파트너십에 유리합니다.
 </div>
 </div>
 `;}
...
${h.complete ? '(완성)' : '(반합)'}
 ...
 <div class="hap-desc">
 삼합은 가장 강력한 합의 기운입니다. ${hap.samhap[0].result}
오행의 힘이 크게 강화되어 
 해당 분야에서 큰 성취가 가능합니다. ${hap.samhap[0].complete
 ? '완전한 삼합으로 매우 강력합니다.'
...
let html=`
 ...
 <div style="background:${c.severity==='중요' ? '#d32f2f' : '#ff9800'}
;color:white;padding:4px 12px;border-radius:20px;font-size:0.85em;">
 ...
 ${c.impact
 ? `<div style="background:#fff;padding:10px;border-radius:8px;color:#d32f2f;font-weight:600;">📍 ${c.impact}
</div>`
 : ''}
<div style="margin-top:8px;color:#666;font-size:0.9em;">위치: ${c.positions
 .map((p)=>{const names={year: '년주',month: '월주',day: '일주',hour: '시주',}
;return names[p];}
).join(',')}
</div>
 </div>
...
if(hyungchung.hyung.length > 0){html+=`
 ...
 <div style="background:${h.severity==='심각' ? '#c62828' : '#ff6f00'}
;color:white;padding:4px 12px;border-radius:20px;font-size:0.85em;">
 ${h.severity}
</div>
 </div>
...
if(hyungchung.pa.length > 0){html+=`
 ...
 <div style="background:#fff;padding:10px;border-radius:8px;color:#e64a19;font-size:0.9em;">💡 ${p.impact}
</div>
 </div>
 `).join('')}
</div>
...
if(hyungchung.hae.length > 0){html+=`
 ...
 <div style="background:#fff;padding:10px;border-radius:8px;color:#f57c00;font-size:0.9em;">📍 영향: ${h.impact}
</div>
 </div>
 `).join('')}
</div>
...
let html='<div class="sinsal-grid">';sinsal.good.forEach((s)=>{html+=`
 ...
 <div class="sinsal-name">⚠️ ${s.name}
</div>
 <div class="sinsal-desc">${s.desc}
</div>
 </div>
 ...
 <div class="sinsal-name" style="color:#f57c00;">⭐ ${s.name}
</div>
 <div class="sinsal-desc">${s.desc}
</div>
 </div>
 ...
 sinsal.bad.length===0 &&
 sinsal.special.length===0){html='<div style="text-align:center;color:#757575;">사주에 특별한 神殺(신살)이 확인되지 않았습니다</div>';}
document.getElementById('sinsal-analysis').innerHTML=html;}
function displayGongmangDetail(saju,yearGan,yearJi){
const jijiList=Object.values(saju.jiji);const pillars=['年支','月支','日支','時支'];let html='<div style="line-height:2;">';html+='<p><strong>▶ 空亡(공망)이란?</strong> 60갑자 순환에서 빠진 지지로,그 위치의 기운이 약하거나 공허함을 의미합니다.</p><br>';html+='<p><strong>▶ 각 기둥의 空亡(공망)여부:</strong></p><ul style="margin-top:10px;">';jijiList.forEach((ji,idx)=>{const isGongmang=getGongmang(yearGan,yearJi,ji);html+=`<li style="padding:8px 0;">${pillars[idx]}
${ji}
: ${isGongmang
 ? '<strong style="color:#c62828;">空亡 ⚠️</strong>-이 분야가 약하거나 공허할 수 있습니다'
 : '<strong style="color:#2e7d32;">정상 ✓</strong>'}
</li>`;}
);html+='</ul><br>';html+='<p><strong>▶ 대처법:</strong> 空亡(공망)이 있는 기둥은 노력으로 보완해야 합니다. 해당 육친이나 분야에 더욱 신경 쓰고 준비하세요.</p>';html+='</div>';document.getElementById('gongmang-detail-analysis').innerHTML=html;}
function displaySpecialSinsal(sinsal){
let html='<div style="line-height:2;">';const hasSpecial=sinsal.good.some((s)=>['天乙貴人','學堂貴人'].includes(s.name))||
 sinsal.bad.some((s)=>['桃花殺','驛馬殺','三災','白虎大殺'].includes(s.name));if(!hasSpecial){html+='<p style="text-align:center;color:#757575;">특별히 주목할 만한 神殺(신살)이 없습니다</p>';}
else{html+='<p><strong>▶ 주요 神殺(신살)상세 해석:</strong></p><br>';sinsal.good.forEach((s)=>{if(['天乙貴人','學堂貴人'].includes(s.name)){html+=`<p style="margin-bottom:15px;">• <strong>${s.name}
:</strong> ${s.desc}
</p>`;}}
);sinsal.bad.forEach((s)=>{if(['桃花殺','驛馬殺','三災','白虎大殺'].includes(s.name)){html+=`<p style="margin-bottom:15px;">• <strong>${s.name}
:</strong> ${s.desc}
</p>`;}}
);}
...
)" style="cursor:pointer;" title="클릭하여 ${daeunStartYear}
년(만 ${daeun.age}
세)연운 보기">
...
);" style="cursor:pointer;" title="클릭하여 ${yeonun.year}
년 월운 보기">
...
const prevYear=years[0];const currentYear=years[1]|| prevYear;const nextYear=years[2]|| years[1]|| prevYear;chartHTML+=`
 ...
 <strong style="color:#1976d2;">익년도 ${nextYear}
년 12개월 → 당년도 ${currentYear}
년 12개월 → 전년도 ${prevYear}
년 12개월</strong>
...
년 운세:</strong><br>
 올해는 ${sewun.gan}
${sewun.ji}
년으로,${sewun.napeum.element}
기운이 강합니다. 
 ${sewun.napeum.element===CHEONGAN_ELEMENT[dayGan]? '일간과 같은 오행이므로 기운이 강해집니다. 적극적으로 활동하기 좋은 해입니다.'
 : `일간(${CHEONGAN_ELEMENT[dayGan]}
)과 ${getSipseong(dayGan,sewun.napeum.element)}
...
<br><br>
 오행 중 <span class="highlight-text">${maxEl}
</span>의 기운이 가장 강하며,사주는 <span class="highlight-text">${strength.level}
</span> 상태입니다.
 </div>
 </div>
 <div class="comprehensive-section">
 ...
 <div class="section-content">
 ${gyeokguk.name}
격국으로,${gyeokguk.name.includes('正官')? '공직,대기업,교육계가 적합합니다. 안정과 명예를 추구합니다.'
 : gyeokguk.name.includes('正財')? '재무,회계,사업 분야가 적합합니다. 꾸준한 재산 축적이 가능합니다.'
 : gyeokguk.name.includes('正印')? '교육,연구,학문 분야가 적합합니다. 자격증과 학위가 도움됩니다.'
 : gyeokguk.name.includes('食神')? '예술,요식업,서비스업이 적합합니다. 사람들에게 즐거움을 주는 일이 좋습니다.'
 : gyeokguk.name.includes('建祿')? '자영업,창업이 적합합니다. 독립적으로 일하는 것을 선호합니다.'
 : gyeokguk.name.includes('從')? '전문기술,특수 분야가 적합합니다. 한 분야에 집중하면 성공합니다.'
 : '다양한 분야에 적응할 수 있습니다. 자신의 강점을 찾아 특화하는 것이 좋습니다.'}
<br><br>
 용신 <span class="highlight-text">${yongsin.yongsin}
...
<br><br>
 ...
 <div class="section-content">
 일주의 십이운성이 <span class="highlight-text">${sibiun.day}
</span>로,${['長生','冠帶','建祿','帝旺'].includes(sibiun.day)? '현재 활동력이 왕성합니다. 적극적으로 기회를 잡고 목표를 추진하세요.'
 :['衰','病','巳','卯'].includes(sibiun.day)? '신중하게 행동해야 하는 시기입니다. 무리하지 말고 차근차근 준비하세요.'
 ...
 <div class="section-content">
 1. <strong>용신 활용:</strong> ${yongsin.yongsin}
오행을 적극 활용하세요. 이와 관련된 색상,방향,직업을 선택하면 좋습니다.<br>
 2. <strong>기신 회피:</strong> ${yongsin.gisin}
...
const yongsinEl=yongsin.yongsin;const elementInfo={木:{color: '녹색,청색',direction: '동쪽',number: '3,8',season: '봄',job: '교육,문화,출판,원예',}
,火:{color: '빨강,주황,보라',direction: '남쪽',number: '2,7',season: '여름',job: '영업,마케팅,방송,연예',}
,土:{color: '노랑,갈색,베이지',direction: '중앙,서남,동북',number: '5,10',season: '환절기',job: '부동산,건설,금융,농업',}
,金:{color: '흰색,은색,금색',direction: '서쪽',number: '4,9',season: '가을',job: '법률,의료,공학,금융',}
,水:{color: '검정,남색,회색',direction: '북쪽',number: '1,6',season: '겨울',job: 'IT,연구,무역,물류',}
,}
;const info=elementInfo[yongsinEl]|| elementInfo['木'];const html=`
 ...
 용신을 이해하고 자신의 강약을 파악하여,부족한 부분은 보완하고 강한 부분은 활용하는 <strong>균형 잡힌 삶의 태도</strong>가 가장 중요합니다. 
 ${strength.level==='太弱(태약)' || strength.level==='弱(약)'
...
console.log('🔍 scrollToWolun 호출-연도:',year);document.querySelectorAll('.yeonun-item').forEach((item)=>{item.style.background='#f8f9fa';item.style.transform='scale(1)';item.style.boxShadow='none';item.style.border='none';}
);SajuAPI.calcWolun(year).then((wolunList)=>{console.log('📊 scrollToWolun-Python API 월운 응답:',wolunList);if(wolunList && wolunList.length > 0){console.log('📊 scrollToWolun-첫 월운 gan:',wolunList[0].gan,'zhi:',wolunList[0].zhi);}
...
,300);}
).catch((error)=>{console.error('❌ scrollToWolun 월운 계산 오류:',error);alert('월운 계산 중 오류가 발생했습니다.');}
);}
...
const daeunStartYear=birthYear+ageRange[0];console.log('🔄 연운 트리거 예약-daeunStartYear:',daeunStartYear,'currentYear:',currentYear);setTimeout(()=>{console.log('▶️ 연운 트리거 실행!');autoTriggerYeonun(daeunStartYear,currentYear);}
,1500);}}
);}
,3000);}
else{console.log('❌ 현재 대운을 찾지 못함');}}
...
);if(!targetYeonunItem){console.log('❌ 목표 연도를 찾지 못함:',targetYear);}
...
setTimeout(()=>{console.log('🌙 월운 자동 트리거 실행');autoTriggerWolun(targetYear);}
,500);}}
else if(attempts < maxAttempts){console.log('⏳ 연운 항목 준비 중... 200ms 후 재시도');setTimeout(checkAndExecute,200);}
else{console.log('❌ 연운 항목 로드 실패(타임아웃)');}}
;setTimeout(checkAndExecute,500);}
function autoTriggerWolun(year){
console.log('🔍 autoTriggerWolun 호출-연도:',year);SajuAPI.calcWolun(year).then((wolunList)=>{console.log('📊 Python API 월운 응답:',wolunList);console.log('📊 첫 번째 월운:',wolunList[0]);if(wolunList && wolunList.length > 0){console.log('📊 첫 월운 gan:',wolunList[0].gan,'zhi:',wolunList[0].zhi);}
const wolunHTML=displayWolun(wolunList);const existingWolunContainer=document.getElementById('wolun-container');if(existingWolunContainer){const tempDiv=document.createElement('div');tempDiv.innerHTML=wolunHTML;const newWolunContainer=tempDiv.firstChild;existingWolunContainer.parentNode.replaceChild(newWolunContainer,existingWolunContainer);}
setTimeout(()=>{const wolunItems=document.querySelectorAll(`.wolun-month-item[data-year="${year}
...
,300);}
).catch((error)=>{console.error('월운 계산 오류:',error);alert('월운 계산 중 오류가 발생했습니다.');}
);}
...
);console.log('✅ 시각 입력 방식 라디오 버튼 이벤트 등록 완료');toggleTimeInput();console.log('✅ 초기 시각 입력 방식 UI 설정 완료');const calendarRadios=document.querySelectorAll('input[name="calendar"]');calendarRadios.forEach((radio)=>{radio.addEventListener('change',toggleYundal);}
...
const goodSinsal=sibiSinsal.filter((s)=> s.type==='good');const badSinsal=sibiSinsal.filter((s)=> s.type==='bad');let html='<div style="margin-top:5px;">';const items=[];if(goodSinsal.length > 0){items.push(`<span style="color:#4caf50;">길신: ${goodSinsal
 .map((s)=> s.name).join(',')}
</span>`);}
...
let html='<div style="margin-top:5px;">';const names=gilsin.map((g)=> g.name).join(',');html+=`<div style="font-weight:700;color:#f57f17;font-size:0.9em;">吉神類: <span style="color:#f9a825;font-size:0.9em;font-weight:400;">${names}
</span></div>`;html+='</div>';return html;}
function generateExtraSinsalSummary(extraSinsal){
const goodSinsal=extraSinsal.filter((s)=> s.type==='good');const warningSinsal=extraSinsal.filter((s)=> s.type==='warning');const badSinsal=extraSinsal.filter((s)=> s.type==='bad');let html='<div style="margin-top:5px;">';const items=[];if(goodSinsal.length > 0){items.push(`<span style="color:#4caf50;">긍정: ${goodSinsal
 .map((s)=> s.name).join(',')}
</span>`);}
...
const goodSinsal=sibiSinsal.filter((s)=> s.type==='good');const badSinsal=sibiSinsal.filter((s)=> s.type==='bad');let html=`
 ...
 총 ${sibiSinsal.length}
개 발견(길신 ${goodSinsal.length}
개,흉신 ${badSinsal.length}
개)</div>
 </div>
...
let html=`
 ...
 총 ${gilsin.length}
개의 길신이 발견되었습니다. 이는 복록과 귀인의 도움을 의미합니다.
 </div>
 </div>
 `;html+=`
 ...
 <div style="font-size:1.2em;font-weight:700;color:#e65100;">✨ ${g.name}
</div>
...
const goodSinsal=extraSinsal.filter((s)=> s.type==='good');const warningSinsal=extraSinsal.filter((s)=> s.type==='warning');const badSinsal=extraSinsal.filter((s)=> s.type==='bad');let html=`
 ...
 총 ${extraSinsal.length}
개 발견(길신 ${goodSinsal.length}
개,주의 ${warningSinsal.length}
개,흉신 ${badSinsal.length}
개)</div>
 </div>
 `;if(goodSinsal.length > 0){html+=`
